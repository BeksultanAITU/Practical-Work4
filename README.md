...
Графики зависимости времени выполнения от размера массива строятся непосредственно в консоли в виде ASCII-столбиков, где длина столбика пропорциональна измеренному времени. Такой способ позволяет отразить требуемые графики без сохранения результатов во внешние файлы и при этом сохранить наглядность зависимости `Time(N)`.
